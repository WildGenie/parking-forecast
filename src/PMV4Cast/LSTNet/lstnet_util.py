...
class LSTNetInit(object):
    ...
    #                        Default: 0.2
    #    mc_iterations:   MC Dropout iterations during testing
    #                        Default: 100
    ...
    #                        Default: False
    #    optimize:        Search the best hyper-parameters with sequential optimization
    #                        Default: False
    #    evals:           Number of trials during the hyper-parameter optimization
    #                        Default: 100
    ...
    #                        Default: log/lstnet
    #
    #    patience:        Early stopping number
    #                     Default: 25
    #
    ...
    def dump(self):
        ...
        log.debug("MC iterations: %f", self.mc_iterations)
        ...
        log.debug("Optimize: %s", self.optimize)
        log.debug("Optimization trials: %s", self.evals)
        ...
        log.debug("Patience: %d", self.patience)
...
def GetArguments():
    ...
    parser.add_argument('--data', type=str, default='../../data/raw/parking_data.txt', required=False, help='Location of the data file. Required!!')
    parser.add_argument('--window', type=int, default=24, help='Window size. Default=24*4')
    parser.add_argument('--horizon', type=int, default=24, help='Horizon width. Default=24')
    ...
    parser.add_argument('--mc-iterations', type=int, default=100, help='MC Dropout iterations durint testing time. Default=100')
    ...
    parser.add_argument('--trainpercent', type=float, default=0.9, help='Percentage of data to be used for training. Default=0.6')
    parser.add_argument('--validpercent', type=float, default=0.1, help='Percentage of data to be used for validation. Default=0.2')
    parser.add_argument('--save', type=str, default='../../save/lstnet', help='Filename initial to save the model and the results in. Default=None')
    parser.add_argument('--load', type=str, default='../../save/lstnet', help='Filename initial of the saved model to be loaded (model and weights). Default=None')
    ...
    parser.add_argument('--debuglevel', type=int, choices=[10, 20, 30, 40, 50], default=40, help='Logging debug level. Default 20 (INFO)')
